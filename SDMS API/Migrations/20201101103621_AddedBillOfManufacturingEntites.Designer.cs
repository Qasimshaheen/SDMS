...
namespace SDMS_API.Migrations
{
    ...
    [Migration("20201101103621_AddedBillOfManufacturingEntites")]
    partial class AddedBillOfManufacturingEntites
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SDMS_API.Data.BankOpeningBalanceMaster", b =>
                {
                    ...
                    b.ToTable("BankOpeningBalanceMasters");
                });
            ...
            modelBuilder.Entity("SDMS_API.Data.ManufacturingBillExpenses", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("ManufacturingBillExpenses");
                });

            modelBuilder.Entity("SDMS_API.Data.ManufacturingBillMaster", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("ManufacturingBillMaster");
                });

            modelBuilder.Entity("SDMS_API.Data.ManufacturingBillProductDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("ManufacturingBillProductDetail");
                });
            ...
            modelBuilder.Entity("SDMS_API.Data.ProductFormulaDetail", b =>
                {
                    ...
                    b.ToTable("ProductFormulaDetails");
                });
            ...
            modelBuilder.Entity("SDMS_API.Data.ProductFormulaMaster", b =>
                {
                    ...
                    b.ToTable("ProductFormulaMasters");
                });
            ...
            modelBuilder.Entity("SDMS_API.Data.BankOpeningBalanceDetail", b =>
                {
                    ...
                    b.HasOne("SDMS_API.Data.BankOpeningBalanceMaster", "TblBankOpeningBalanceMaster")
                        .WithMany("BankOpeningBalanceDetails")
            ...
            modelBuilder.Entity("SDMS_API.Data.ManufacturingBillExpenses", b =>
                {
                    b.HasOne("SDMS_API.Data.ManufacturingBillProductDetail", "TblManufacturingBillProductDetail")
                        .WithMany("ManufacturingBillExpenses")
            ...
            modelBuilder.Entity("SDMS_API.Data.ManufacturingBillProductDetail", b =>
                {
                    b.HasOne("SDMS_API.Data.ManufacturingBillMaster", "TblManufacturingBillMaster")
                        .WithMany("ManufacturingBillProductDetails")
